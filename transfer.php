...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="subbody">
      ...
      <form class="row gy-2 gx-3 align-items-center" action="" style="margin-left: 37%; margin-right:25%;" method="post">
        <div class="form" >
        ...
        <div class="mb-3 row" >
          ...
          <div class="col-sm-10">
            <input required type="text" placeholder="amount" name="tamount" id="amountbtn" class="form-control" style="margin-top:20px;">
          </div>
        </div>
            <div class="button-container" >
          <button name="transfer" class="btn btn-lg btn-dark tbtn" style="padding-left:50px; padding-right:50px;">Transfer</button>
        </div>
      <?php
      include 'connection.php';
